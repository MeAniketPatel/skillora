    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-500">
          View and verify your earned certificates of course completion.
        </p>
      </div>
      ...
      {certificates.length === 0 ? (
        <Card className="bg-white dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/50">
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-neutral-500 mt-1 max-w-sm">
              Complete a course syllabus with 100% progress and assessments to
              earn your first certified credential.
            </p>
            <LinkButton className="mt-6 font-semibold" href="/courses">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {certificates.map((cert) => (
            <Card
              key={cert.id}
              className="bg-white dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/50 relative overflow-hidden"
            >

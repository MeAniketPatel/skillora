// Auto-generated service wrapper for the discussions feature.
...
export const discussionsService = {
  getDiscussionsList: discussionRepo.getDiscussionsList,
  getDiscussionThread: discussionRepo.getDiscussionThread,
  async createDiscussion(...args: Parameters<typeof discussionRepo.createDiscussion>): Promise<Awaited<ReturnType<typeof discussionRepo.createDiscussion>>> {
  ...
  async addDiscussionReply(...args: Parameters<typeof discussionRepo.addDiscussionReply>): Promise<Awaited<ReturnType<typeof discussionRepo.addDiscussionReply>>> {
  ...
  async togglePinDiscussion(...args: Parameters<typeof discussionRepo.togglePinDiscussion>): Promise<Awaited<ReturnType<typeof discussionRepo.togglePinDiscussion>>> {
  ...
  async toggleLockDiscussion(...args: Parameters<typeof discussionRepo.toggleLockDiscussion>): Promise<Awaited<ReturnType<typeof discussionRepo.toggleLockDiscussion>>> {
  ...
  async createQuestion(...args: Parameters<typeof qaRepo.createQuestion>): Promise<Awaited<ReturnType<typeof qaRepo.createQuestion>>> {
  ...
  async createAnswer(...args: Parameters<typeof qaRepo.createAnswer>): Promise<Awaited<ReturnType<typeof qaRepo.createAnswer>>> {
  ...
  getQuestionsForLesson: qaRepo.getQuestionsForLesson,
  getQuestionsForTeacher: qaRepo.getQuestionsForTeacher,
  async markQuestionResolved(...args: Parameters<typeof qaRepo.markQuestionResolved>): Promise<Awaited<ReturnType<typeof qaRepo.markQuestionResolved>>> {

  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500">Track your progress and continue where you left off.</p>
      </div>
      ...
      {enrollments.length === 0 ? (
        <Card className="flex flex-col items-center justify-center p-12 text-center bg-white/70 dark:bg-neutral-900/70 border-dashed border-2 border-neutral-300 dark:border-neutral-700">
          ...
          <CardTitle className="text-xl font-bold">No enrolled courses</CardTitle>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {enrollments.map((enrollment) => {
            ...
            return (
              <Card key={enrollment.id} className="overflow-hidden hover:shadow-lg transition-shadow bg-white dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/50 flex flex-col justify-between">
                ...
                <CardHeader className="p-4 flex-1">
                  ...
                  <CardDescription className="text-xs mt-1">Level: {course.level}</CardDescription>
                </CardHeader>

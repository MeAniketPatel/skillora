...
export async function toggleBookmark(...args: Parameters<typeof bookmarkRepo.toggleBookmark>): Promise<Awaited<ReturnType<typeof bookmarkRepo.toggleBookmark>>> {
...
export async function createCollection(...args: Parameters<typeof collectionRepo.createCollection>): Promise<Awaited<ReturnType<typeof collectionRepo.createCollection>>> {
...
export async function addCourseToCollection(...args: Parameters<typeof collectionRepo.addCourseToCollection>): Promise<Awaited<ReturnType<typeof collectionRepo.addCourseToCollection>>> {
...
export async function removeCourseFromCollection(...args: Parameters<typeof collectionRepo.removeCourseFromCollection>): Promise<Awaited<ReturnType<typeof collectionRepo.removeCourseFromCollection>>> {
...
export async function deleteCollection(...args: Parameters<typeof collectionRepo.deleteCollection>): Promise<Awaited<ReturnType<typeof collectionRepo.deleteCollection>>> {
...
export async function createGoal(...args: Parameters<typeof learningGoalRepo.createGoal>): Promise<Awaited<ReturnType<typeof learningGoalRepo.createGoal>>> {
...
export async function updateGoalProgress(...args: Parameters<typeof learningGoalRepo.updateGoalProgress>): Promise<Awaited<ReturnType<typeof learningGoalRepo.updateGoalProgress>>> {
...
export async function deleteGoal(...args: Parameters<typeof learningGoalRepo.deleteGoal>): Promise<Awaited<ReturnType<typeof learningGoalRepo.deleteGoal>>> {
...
export async function upsertLessonProgress(...args: Parameters<typeof lessonProgressRepo.upsertLessonProgress>): Promise<Awaited<ReturnType<typeof lessonProgressRepo.upsertLessonProgress>>> {
...
export async function createNote(...args: Parameters<typeof noteRepo.createNote>): Promise<Awaited<ReturnType<typeof noteRepo.createNote>>> {
...
export async function updateNote(...args: Parameters<typeof noteRepo.updateNote>): Promise<Awaited<ReturnType<typeof noteRepo.updateNote>>> {
...
export async function deleteNote(...args: Parameters<typeof noteRepo.deleteNote>): Promise<Awaited<ReturnType<typeof noteRepo.deleteNote>>> {
...
export async function recordStudySession(...args: Parameters<typeof streakRepo.recordStudySession>): Promise<Awaited<ReturnType<typeof streakRepo.recordStudySession>>> {
